...
- **`drivemap/`** — a standalone FastAPI + vanilla-JS web app that replays real OBD2+GPS drive logs on PLATEAU 3D city models via CesiumJS, GT-style. See `drivemap/CLAUDE.md` for its commands and architecture.
