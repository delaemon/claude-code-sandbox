...
- **`hanedamap/`** — a standalone FastAPI + vanilla-JS web app that draws live aircraft positions within 100 km of Haneda Airport on Google Maps, polling public ADS-B APIs every second. See `hanedamap/CLAUDE.md` for its commands and architecture.
